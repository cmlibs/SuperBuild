function(add_project _PROJECT_NAME)
    ...
    if (OPENCMISS_SETUP_TYPE STREQUAL "dependencies")
        ...
        set(_PROJECT_BINARY_DIR "${OPENCMISS_ROOT}/build${SINGLE_BUILD_DIR_LABEL}/${FOLDER_NAME}")
    else()
        if (_PROJECT_NAME IN_LIST DEPENDENCY_PROJECTS)
            set(_PROJECT_SOURCE_DIR "${OPENCMISS_ROOT}/src/dependencies/${FOLDER_NAME}")
            set(_PROJECT_BINARY_DIR "${OPENCMISS_ROOT}/build${SINGLE_BUILD_DIR_LABEL}/dependencies/${FOLDER_NAME}")
        else()
            set(_PROJECT_SOURCE_DIR "${OPENCMISS_ROOT}/src/${FOLDER_NAME}")
            set(_PROJECT_BINARY_DIR "${OPENCMISS_ROOT}/build${SINGLE_BUILD_DIR_LABEL}/${FOLDER_NAME}")
        endif()
